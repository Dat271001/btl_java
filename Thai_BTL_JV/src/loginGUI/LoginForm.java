...
//            System.out.println(username + " -- " + pass);
            ...
            if(checkFlag) JOptionPane.showMessageDialog(null, "Login successful!");
            else JOptionPane.showMessageDialog(null, "Invalid username or password!");
            
            String info = BTL_Java.accountProcess.GetInfo(username);
            System.out.println(info);
            BTL_Java.mainScreen = new MainScreen(info);
